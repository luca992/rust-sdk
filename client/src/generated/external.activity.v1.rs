...
pub struct UpdatePaymentMethodRequest {
    ...
    #[serde(default)]
    pub parameters: ::core::option::Option<
        super::super::super::immutable::activity::billing::UpdatePaymentMethodIntent,
    >,
    #[serde(default)]
    pub generate_app_proofs: ::core::option::Option<bool>,
}
...
pub struct UpdateWalletAccountNameRequest {
    ...
    #[serde(default)]
    pub parameters: ::core::option::Option<
        super::super::super::immutable::activity::v1::UpdateWalletAccountNameIntent,
    >,
    #[serde(default)]
    pub generate_app_proofs: ::core::option::Option<bool>,
}
...
pub struct SolSendTransactionRequest {
    ...
    #[serde(default)]
    pub parameters: ::core::option::Option<
        super::super::super::immutable::activity::v1::SolSendTransactionIntentV2,
    >,
    #[serde(default)]
    pub generate_app_proofs: ::core::option::Option<bool>,
}
...
pub struct ExecuteSwapRequest {
    ...
    #[serde(default)]
    pub parameters: ::core::option::Option<
        super::super::super::immutable::activity::v1::ExecuteSwapIntentV2,
    >,
    #[serde(default)]
    pub generate_app_proofs: ::core::option::Option<bool>,
}
...
pub struct CreateSwapQuoteRequest {
    ...
    #[serde(default)]
    pub parameters: ::core::option::Option<
        super::super::super::immutable::activity::v1::CreateSwapQuoteIntent,
    >,
    #[serde(default)]
    pub generate_app_proofs: ::core::option::Option<bool>,
}
...
pub struct ClaimSwapFeesRequest {
    ...
    #[serde(default)]
    pub parameters: ::core::option::Option<
        super::super::super::immutable::activity::v1::ClaimSwapFeesIntent,
    >,
    #[serde(default)]
    pub generate_app_proofs: ::core::option::Option<bool>,
}
...
pub struct UpsertSwapConfigRequest {
    ...
    #[serde(default)]
    pub parameters: ::core::option::Option<
        super::super::super::immutable::activity::v1::UpsertSwapConfigIntent,
    >,
    #[serde(default)]
    pub generate_app_proofs: ::core::option::Option<bool>,
}
...
pub struct CreateTvcOperatorRequest {
    ...
    #[serde(default)]
    pub parameters: ::core::option::Option<
        super::super::super::immutable::activity::v1::CreateTvcOperatorIntent,
    >,
    #[serde(default)]
    pub generate_app_proofs: ::core::option::Option<bool>,
}
...
pub struct CreateTvcQuorumKeyRequest {
    ...
    #[serde(default)]
    pub parameters: ::core::option::Option<
        super::super::super::immutable::activity::v1::CreateTvcQuorumKeyIntent,
    >,
    #[serde(default)]
    pub generate_app_proofs: ::core::option::Option<bool>,
}
...
pub struct ReEncryptTvcQuorumKeyShareRequest {
    ...
    #[serde(default)]
    pub parameters: ::core::option::Option<
        super::super::super::immutable::activity::v1::ReEncryptTvcQuorumKeyShareIntent,
    >,
    #[serde(default)]
    pub generate_app_proofs: ::core::option::Option<bool>,
}
...
pub struct InitImportSecretsRequest {
    ...
    #[serde(default)]
    pub parameters: ::core::option::Option<
        super::super::super::immutable::activity::v1::InitImportSecretsIntent,
    >,
}
#[derive(Debug)]
#[derive(::serde::Serialize, ::serde::Deserialize)]
...
pub struct ImportSecretsRequest {
    ...
    #[serde(default)]
    pub parameters: ::core::option::Option<
        super::super::super::immutable::activity::v1::ImportSecretsIntent,
    >,
}
#[derive(Debug)]
#[derive(::serde::Serialize, ::serde::Deserialize)]
...
pub struct DeleteSecretsRequest {
    ...
    #[serde(default)]
    pub parameters: ::core::option::Option<
        super::super::super::immutable::activity::v1::DeleteSecretsIntent,
    >,
}
#[derive(Debug)]
#[derive(::serde::Serialize, ::serde::Deserialize)]
...
pub struct EarnDeployWrapperRequest {
    ...
    #[serde(default)]
    pub parameters: ::core::option::Option<
        super::super::super::immutable::activity::v1::EarnDeployWrapperIntent,
    >,
    #[serde(default)]
    pub generate_app_proofs: ::core::option::Option<bool>,
}
...
pub struct EarnDepositRequest {
    ...
    #[serde(default)]
    pub parameters: ::core::option::Option<
        super::super::super::immutable::activity::v1::EarnDepositIntent,
    >,
    #[serde(default)]
    pub generate_app_proofs: ::core::option::Option<bool>,
}
...
pub struct EarnWithdrawRequest {
    ...
    #[serde(default)]
    pub parameters: ::core::option::Option<
        super::super::super::immutable::activity::v1::EarnWithdrawIntent,
    >,
    #[serde(default)]
    pub generate_app_proofs: ::core::option::Option<bool>,
}
...
pub struct EarnSetWrapperStateRequest {
    ...
    #[serde(default)]
    pub parameters: ::core::option::Option<
        super::super::super::immutable::activity::v1::EarnSetWrapperStateIntent,
    >,
    #[serde(default)]
    pub generate_app_proofs: ::core::option::Option<bool>,
}
...
pub struct ClaimEarnFeesRequest {
    ...
    #[serde(default)]
    pub parameters: ::core::option::Option<
        super::super::super::immutable::activity::v1::ClaimEarnFeesIntent,
    >,
    #[serde(default)]
    pub generate_app_proofs: ::core::option::Option<bool>,
}
...
pub struct EthUndelegate7702Request {
    ...
    #[serde(default)]
    pub parameters: ::core::option::Option<
        super::super::super::immutable::activity::v1::EthUndelegate7702Intent,
    >,
    #[serde(default)]
    pub generate_app_proofs: ::core::option::Option<bool>,
}
...
#[serde(rename_all = "camelCase")]
#[derive(Clone, PartialEq)]
pub struct CreateVelocityControlRequest {
    pub r#type: ::prost::alloc::string::String,
    pub timestamp_ms: ::prost::alloc::string::String,
    pub organization_id: ::prost::alloc::string::String,
    #[serde(default)]
    pub parameters: ::core::option::Option<
        super::super::super::immutable::activity::v1::CreateVelocityControlIntent,
    >,
    #[serde(default)]
    pub generate_app_proofs: ::core::option::Option<bool>,
}
...
pub struct DeleteVelocityControlRequest {
    ...
    #[serde(default)]
    pub parameters: ::core::option::Option<
        super::super::super::immutable::activity::v1::DeleteVelocityControlIntent,
    >,
    #[serde(default)]
    pub generate_app_proofs: ::core::option::Option<bool>,
}
